...
export class Router {
    ...
    registerRoute(method,path,cb,options = {}) {  
        ...
        if(!this.getAllowedMethods().includes(method)) throw new Error(`Invalid method ${method} passed to registerRoute`)
    ...
    get(path, cb, options = {}) {
        this.registerRoute(`get`, path, cb, options)
    }
    post(path, cb, options = {}) {
        this.registerRoute(`post`, path, cb, options)
    }
    put(path, cb, options = {}) {
        this.registerRoute(`put`, path, cb, options)
    }
    patch(path, cb, options = {}) {
        this.registerRoute(`patch`, path, cb, options)
    }
    delete(path, cb, options = {}) {
        this.registerRoute(`delete`, path, cb, options)
    }
    head(path, cb, options = {}) {
        this.registerRoute(`head`, path, cb, options)
    }
